import gym
from classes import Agent, Model
import numpy as np
...
if __name__=='__main__':
    ...
    agent=Agent(gamma=0.99, epsilon=1.0, alpha=0.00035, input_dims=(180,160,4),
                n_actions=3, mem_size=30000, batch_size=32)
    if load_checkpoint:
        agent.load_models()
    scores=[]
    numGames=200
    ...
    for i in range(numGames):
        ...
        if i%10==0 and i>0:
            ...
            print(f'game:{i}, score:{score}, average score is:{avg_score},epsilon at {agent.epsilon}')
            agent.save_models()
        else:
